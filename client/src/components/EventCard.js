        ...
        return <div>
            ...
            <div className="row">
              <div className="row1left col-5">
                ...
                <input className="form-control-md" type="text" placeholder="Time/Location" value= {this.props.card.dateTime} readOnly /> <br />
              ...
              <div className="row1right col-5"><img src={this.bannerImg} alt="" width={300} height={140} /></div>
            </div>

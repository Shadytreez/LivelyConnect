...
//serialize and deserialize is used to save user info to the session cookie

//serializeUser is used to store the user id into the cookie
passport.serializeUser((user, done) => {
  done(null, user.id);
});

//used to let us know if the user is logged in by looking into the cookie
